...
- (UIImage *)js_imageMaskWithColor:(UIColor *)maskColor
                      shadowOffset:(CGPoint)shadow
{
    CGFloat shadowOpacity = 0.54f;
    BOOL hasShadow = !CGPointEqualToPoint(shadow, CGPointZero);
    ...
    if(hasShadow) {
        ...
        CGContextSetFillColorWithColor(ctx, [UIColor colorWithWhite:0.0f alpha:shadowOpacity].CGColor);
