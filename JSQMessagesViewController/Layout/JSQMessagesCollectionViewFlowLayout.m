...
- (void)jsq_configureFlowLayout
{
    ...
    _messageBubbleTopLabelLeftRightMargin = 60.0f;
...
{
    NSAssert(messageBubbleTopLabelLeftRightInset >= 0.0f, @"ERROR: messageBubbleTopLabelLeftRightMargin must be greater than or equal to 0: %s", __PRETTY_FUNCTION__);
