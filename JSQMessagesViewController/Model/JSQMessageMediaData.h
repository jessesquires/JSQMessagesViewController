...
/**
 *  @return String which identifies type of the data returned by `copyableData` method.
 *
...
/**
 *  @return Data object of class corresponding to type returned by `copyableDataType`.
 *
